...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Welcome To Logo Detection App</h1>
      <h2></h2>
      ...
      <div class="container">
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            ...
            <p>
             We are a group of software developers , and our website found to help you know how much your fame in social media especially in Twitter and Instagram , By helping you found your Logo in these social media
               </p>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
            <div class="box">
              ...
              <h4 class="title"><a href="<?php echo e(url('contactUS')); ?>">Training The Model</a></h4>
              <p class="description">Contact us to train model for your own Logo</p>
            </div>
          </div>
		 ...
		 <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="box">
              ...
              <h4 class="title"><a href="<?php echo e(url('searchimages')); ?>" >Social Media</a></h4>
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              <div>
                ...
                <p>Palestine Street<br>Nablus</p>
              </div>
