...
use MongoClient;
class listen_for_wataniya extends Command
{
    /**
    ...
    protected $signature = 'twitter:listen-for-wataniya';
   ...
   */
    public function handle()
    {
        ...
        $collection=$db->selectCollection("TWataniyaimages");
        TwitterStreamingApi::publicStream()
            ->whenHears ('wataniya,wataniya mobile', function (array $tweet) use ($collection) {
