...
PATH_TO_CKPT ='frozen_inference_graphj.pb'
PATH_TO_LABELS ='object-detectionj.pbtxt'
...
db = connection.ProDB
db.drop_collection('Jawwalexist')

#handle to friends Collection
data = db.Jawwalimages



db.create_collection('Jawwalexist')
data2 = db.Jawwalexist
List = data.find()
...
for item in List:
    url =item["url" ]
    time=item["time"]
    im=urlretrieve(url, "DBimages/1.jpg")
    result = detect_objects('C:/Users/hp/Desktop/project/Graduation-project/LaravelGraduationProject/Demo/DBimages/1.jpg')
